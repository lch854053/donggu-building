...
// 16개 상세기능 화이트리스트. 단지명 보정엔 동별개요(getHpDongOulnInfo)가 가장 신뢰.
const ALLOWED_OPS = new Set([
  "getHpBasisOulnInfo", "getHpDongOulnInfo", "getHpFlrOulnInfo", "getHpHoOulnInfo",
  "getHpSbsdFcInfo", "getHpWclfInfo", "getHpPklotInfo", "getHpAtchPklotInfo",
  "getHpExposPubuseAreaInfo", "getHpHoExposPubuseAreaInfo", "getHpActOulnInfo",
  "getHpMgmCoopTpOulnInfo", "getHpMgmCoopSbsdWlfarFcInfo", "getHpJijiguInfo",
  "getHpWlfarLotouFcInfo", "getHpPlatPlcInfo",
]);

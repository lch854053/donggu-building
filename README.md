...
Figure-Ground의 용적률 모드는 D199 건축물대장의 `용적율` 기재값을 `far` 속성으로 표시합니다. `100% 이하`, `100% 초과–200% 이하`, `200% 초과–300% 이하`, `300% 초과–500% 이하`, `500% 초과`의 5단계이며, 0·음수·미기재 값은 미확인으로 표시합니다. 이 구간은 동구 데이터 분포와 국토계획법 시행령 제85조의 주거·준주거 용적률 경계를 참고한 시각화 구간으로, 법정 허용 용적률 판정값이 아닙니다.

Figure-Ground의 지상층수 모드는 D199 건축물대장의 `지상층수` 기재값을 `floors` 속성으로 표시합니다. 동구의 유효값 12,382건 분포를 기준으로 `1층`, `2–3층`, `4–5층`, `6–9층`, `10–19층`, `20층 이상`의 6단계로 구분하며, 0·미기재 값은 미확인으로 표시합니다.
